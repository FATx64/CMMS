...
from cmms.views import DashboardEmployeeView, DashboardView, DashboardWorkPlaceView, HomeView, SetupView
...
dashboard_urls = (
    [
        ...
        re_path('^/workplace/?$', DashboardWorkPlaceView.as_view(), name="workplace"),
    ],
    "dashboard"
)
