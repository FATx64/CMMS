    ...
    Equipment.findAll({
        ...
        .then((equipments) => {
            if (equipments) {
                ...
                res.render("reportDepartmentEquipments", {
                    layout: "departmentReportLayout",
                ...
                res.render("error", {
                    ...
                    pageTitle: "Error",
                    message:
                        "Sorry!! Couldn't Find  Any Equipment For This Department",
                    href: "/report/department/equipments/" + code,
                })
            }
        })
        .catch((err) => {
...
exports.departmentEngineersReport = (req, res) => {
    ...
    ClinicalEngineer.findAll({ where: { DepartmentCode: code } })
        .then((engineers) => {
            if (engineers) {
                ...
                res.render("reportDepartmentEngineers", {
                    layout: "departmentReportLayout",
                    pageTitle: "Clinical Engineer",
                    code: code,
                    engineers: en,
                    hasEngineers: en.length > 0,
                    CE: true,
                    name: name,
                })
            } else {
                res.render("error", {
                    ...
                    pageTitle: "Error",
                    message:
                        "Sorry!! Couldn't Find  Any Engineers For This Department",
                    href: "/report/department/enginers/" + code,
                })
            }
        })
        .catch((err) => {
            if (err)
                res.render("error", {
                    ...
                    pageTitle: "Error",
                    message:
                        "Sorry!!  Error happend while getting Engineers For This Department",
                    href: "/report/department/enginers/" + code,
                })
        })
}
...
exports.agentSparePartsReport = (req, res) => {
    ...
    SparePart.findAll({ where: { AgentSupplierId: id } })
        .then((spareparts) => {
            if (spareparts) {
                ...
                res.render("reportAgentSpareParts", {
                    layout: "agentReportLayout",
                ...
                res.render("error", {
                    ...
                    pageTitle: "Error",
                    message:
                        "Sorry!! Couldn't Find  Any Spare Parts For This Agent",
                    href: "/report/department/enginers/" + code,
                })
            }
        })
        .catch((err) => {
            if (err)
                res.render("error", {
                    ...
                    pageTitle: "Error",
                    message:
                        "Sorry!!  Error happend while getting Spare Parts For This Agent",
                    href: "/report/department/enginers/" + code,
                })
        })
}
    ...
    Equipment.findAll({
        ...
        .then((equipments) => {
            if (equipments) {
                ...
                res.render("reportAgentEquipments", {
                    layout: "agentReportLayout",
                    pageTitle: "Equipments",
                    Id: id,
                    name: name,
                ...
                res.render("error", {
                    ...
                    pageTitle: "Error",
                    message:
                        "Sorry!! Couldn't Find  Any Equipment For This Agent",
                    href: "/report/department/enginers/" + code,
                })
            }
        })
        .catch((err) => {
            if (err)
                res.render("error", {
                    ...
                    pageTitle: "Error",
                    message:
                        "Sorry!!  Error happend while getting Equipments For This Agent",
                    href: "/report/department/enginers/" + code,
                })
        })
}
...
exports.equipmentInstallationReport = (req, res) => {
    ...
    Equipment.findOne({
        where: { Code: id },
        include: [{ model: AgentSupplier }, { model: Department }],
    }).then((equipment) => {
        if (equipment) {
            const eq = {
                Code: equipment.Code,
            ...
            res.render("error", {
                ...
                pageTitle: "Error",
                message:
                    "Sorry!!  Error happend while getting Data for This Equipment ",
                href: "/report/department/enginers/" + code,
            })
    })
}
            ...
            DialyInspection.findAll({
                ...
                const reps = reports.map((report) => {
                    return {
                        ...
                        DATE: report.DATE,
                        Engineer:
                            report.ClinicalEnginner.FName +
                            " " +
                            report.ClinicalEnginner.LName,
        ...
        .catch((err) => {
            if (err) {
                ...
                res.render("error", {
                    ...
                    pageTitle: "Error",
                    message:
                        "Sorry!!  Error happend while getting Dialy Inspection Reports for This Equipment ",
                    href: "/equipment",
                })
            }
        })
...
exports.dialyInspectionReport = (req, res) => {
    ...
    DialyInspection.findOne({
        ...
        res.render("dialyinspection", {
            layout: layout,
            pageTitle: "Dialy Inspection",
            code: rep.EquipmentCode,
            DI: di,
            report: rep,
            Reports: Reports,
        })
...
exports.PpmReport = (req, res) => {
    ...
    PPM.findOne({
        ...
        rep.Q4 = rep.Q4 == "on" ? true : false
        rep.Q5 = rep.Q5 == "on" ? true : false
        PPMQuestions.findOne({
            where: { EquipmentCode: rep.EquipmentCode },
        }).then((questions) => {
            const q = {
                Q1: questions.Q1,
                Q2: questions.Q2,
...
exports.equipmentBreakDownReport = (req, res) => {
    ...
    Equipment.findByPk(code).then((eq) => {
        ...
        model = eq.Model
        image = eq.Image
        BreakDown.findAll({ where: { EquipmentCode: code } }).then(
            (breakdowns) => {
                ...
                res.render("equipmentBreakDowns", {
                    layout: "equipmentReportLayout",
                    pageTitle: "Break Downs",
                    code: code,
                    BD: true,
                    breakDowns: bds,
                    hasBreakDowns: bds.length > 0,
                    name: name,
                    model: model,
                    image: image,
                })
...
exports.equipmentMaintenaceReport = (req, res) => {
    ...
    Equipment.findByPk(code).then((eq) => {
        ...
        image = eq.Image
        Maintenance.findAll({
            include: [{ model: BreakDown, where: { EquipmentCode: code } }],
        }).then((maintenances) => {
