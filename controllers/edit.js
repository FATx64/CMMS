...
exports.editClinicalEngineer = (req, res) => {
    dssn = req.params.id
    ClinicalEngineer.findOne({
        where: { DSSN: dssn },
        include: [{ model: Department }],
    })
        .then((clinicalEngineer) => {
            const cs = {
