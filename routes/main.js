...
router.post(
    ...
    homeController.dialyInspectionEngineerPost
)
router.get("/engineer/ppm", homeController.ppmEngineer)
router.post("/engineer/ppm/equipment", homeController.ppmEngineerPost)
router.post(
    "/engineer/ppmEquipment/:Code",
    homeController.ppmEngineerEquipmentPost
)
router.get("/engineer/workOrder", homeController.workorder)
router.get(
    "/engineer/workOrder/description/:code",
    homeController.workorderDescription
)
